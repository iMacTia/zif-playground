...
class Zif::UI::NinePanel
  def left_edge(); end

  def left_edge=(new_edge); end

  def lower_edge(); end

  def lower_edge=(new_edge); end

  def lower_left_corner(); end

  def lower_left_corner=(new_corner); end

  def lower_right_corner(); end

  def lower_right_corner=(new_corner); end

  def right_edge(); end

  def right_edge=(new_edge); end

  def upper_edge(); end

  def upper_edge=(new_edge); end

  def upper_left_corner(); end

  def upper_left_corner=(new_corner); end

  def upper_right_corner(); end

  def upper_right_corner=(new_corner); end
end

class Zif::UI::NinePanelEdge
  def cur_left_edge_width(); end

  def cur_left_edge_width=(cur_left_edge_width); end

  def cur_right_edge_width(); end

  def cur_right_edge_width=(cur_right_edge_width); end

  def left_edge(); end

  def left_edge=(left_edge); end

  def left_edge_height(); end

  def left_edge_height=(left_edge_height); end

  def left_edge_path(); end

  def left_edge_path=(left_edge_path); end

  def right_edge(); end

  def right_edge=(right_edge); end

  def right_edge_height(); end

  def right_edge_height=(right_edge_height); end

  def right_edge_path(); end

  def right_edge_path=(right_edge_path); end
end
